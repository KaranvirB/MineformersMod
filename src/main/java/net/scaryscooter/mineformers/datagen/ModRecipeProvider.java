...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        twoByTwoPacker(consumer, RecipeCategory.MISC, Blocks.CRAFTING_TABLE, 1, ModBlocks.CYBERFORMED_PLANKS.get());
        oneToOneRecipe(consumer, RecipeCategory.REDSTONE, ModBlocks.CYBERFORMED_BUTTON.get(), 1, ModBlocks.CYBERFORMED_PLANKS.get());
...
//                .save(consumer);
    ...
    protected static void oreCooking(Consumer<FinishedRecipe> p_250791_, RecipeSerializer<? extends AbstractCookingRecipe> p_251817_, List<ItemLike> p_249619_, RecipeCategory p_251154_, ItemLike p_250066_, float p_251871_, int p_251316_, String p_251450_, String p_249236_) {
        for(ItemLike itemlike : p_249619_) {
            SimpleCookingRecipeBuilder.generic(Ingredient.of(itemlike), p_251154_, p_250066_, p_251871_, p_251316_, p_251817_).group(p_251450_)
                    .unlockedBy(getHasName(itemlike), has(itemlike)).save(p_250791_, new ResourceLocation(Mineformers.MOD_ID, getItemName(p_250066_)) + p_249236_ + "_" + getItemName(itemlike));
        }
    ...
    protected static void nineBlockStorageRecipes(Consumer<FinishedRecipe> p_250423_, RecipeCategory p_250083_, ItemLike p_250042_,
        ...
        ShapelessRecipeBuilder.shapeless(p_250083_, p_250042_, 9).requires(p_251911_).group(p_250414_).unlockedBy(getHasName(p_251911_), has(p_251911_))
                .save(p_250423_, new ResourceLocation(Mineformers.MOD_ID, p_252237_));
        ShapedRecipeBuilder.shaped(p_248977_, p_251911_).define('#', p_250042_).pattern("###").pattern("###").pattern("###").group(p_248641_)
                .unlockedBy(getHasName(p_250042_), has(p_250042_)).save(p_250423_, new ResourceLocation(Mineformers.MOD_ID, p_250475_));
    }


    protected static void stickRecipe(Consumer<FinishedRecipe> consumer, RecipeCategory category, ItemLike itemLike, int count, ItemLike itemLike1) {
        ShapedRecipeBuilder.shaped(category, itemLike, count)
                .define('#', itemLike1)
                .pattern("#")
                .pattern("#")
                .unlockedBy(getHasName(itemLike1),
                has(itemLike1)).save(consumer, new ResourceLocation(Mineformers.MOD_ID, getItemName(itemLike)) + "_from_" + getItemName(itemLike1));
    }

    protected static void twoByTwoPacker(Consumer<FinishedRecipe> consumer, RecipeCategory recipeCategory, ItemLike itemLike, int count, ItemLike itemLike1) {
        ShapedRecipeBuilder.shaped(recipeCategory, itemLike, count)
                .define('#', itemLike1)
                .pattern("##")
                .pattern("##")
                .unlockedBy(getHasName(itemLike1), has(itemLike1))
                .save(consumer, new ResourceLocation(Mineformers.MOD_ID, getItemName(itemLike) + "_from_" + getItemName(itemLike1)));
    }

    protected static void oneToOneRecipe(Consumer<FinishedRecipe> consumer, RecipeCategory recipeCategory, ItemLike itemLike, int count, ItemLike itemLike1) {
        ShapelessRecipeBuilder.shapeless(recipeCategory, itemLike, count)
                .requires(itemLike1)
                .unlockedBy(getHasName(itemLike1), has(itemLike1))
                .save(consumer, new ResourceLocation(Mineformers.MOD_ID, getItemName(itemLike) + "_from_" + getItemName(itemLike1)));
    }
