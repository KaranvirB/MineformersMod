package net.scaryscooter.mineformers;
...
@Mod(Mineformers.MOD_ID)
public class Mineformers {
    public static final String MOD_ID = "mineformers";
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event) {
        ...
        if(event.getTab() == ModCreativeModeTabs.MINEFORMERS_TAB.get()) {
            ...
            event.accept(ModBlocks.CYBERFORMED_BUTTON);
        }
