...
public enum ModArmorMaterials implements ArmorMaterial {
    TRANSFORMIUM("transformium", 30,Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266655_) -> {
        p_266655_.put(ArmorItem.Type.BOOTS, 3);
        p_266655_.put(ArmorItem.Type.LEGGINGS, 5);
        p_266655_.put(ArmorItem.Type.CHESTPLATE, 7);
        p_266655_.put(ArmorItem.Type.HELMET, 3);
    }), 20, SoundEvents.ARMOR_EQUIP_NETHERITE, 1.0F, 0.1F, () -> {
        return Ingredient.of(ModItems.TRANSFORMIUM.get());
    });
    ...
    public String getName() {
        return Mineformers.MOD_ID + ":" + this.name;
    }
